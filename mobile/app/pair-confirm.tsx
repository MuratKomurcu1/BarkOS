    ...
    <View ref={setPairConfirmRootRef} style={[styles.container, containerPadding]}>
      ...
      <View style={styles.content}>
        {offer && resolvedStatus === 'awaiting-confirm' && (
          <>
            <Text style={styles.title}>Bu bilgisayarla eşleştirilsin mi?</Text>
            <Text style={styles.subtitle}>
              Bilgisayarınızdan bir eşleştirme bağlantısı açtınız. Bilgisayarı listenize eklemek
              için onaylayın.
            </Text>
            <View style={styles.actionStack}>
              <Pressable style={styles.primaryButton} onPress={() => void confirm()}>
                <Text style={styles.primaryButtonText}>Eşleştir</Text>
              </Pressable>
