      ...
      >
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={styles.rowLabel}>Sohbet arayüzü</Text>
            <ChevronRight size={16} color={colors.textMuted} />
          </Pressable>
          <View style={styles.separator} />
          <Pressable
          ...
          >
            ...
            <Text style={styles.rowLabel}>Tarayıcı</Text>
            <ChevronRight size={16} color={colors.textMuted} />
          </Pressable>
          <View style={styles.separator} />
          <Pressable
          ...
          >
            ...
            <Text style={styles.rowLabel}>Sorun giderme</Text>
            <ChevronRight size={16} color={colors.textMuted} />
          </Pressable>
          <View style={styles.separator} />
          <Pressable
          ...
          <View style={[styles.section, styles.sectionSpacer]}>
            <View style={styles.credentialCleanupRow}>
              ...
              <View style={styles.credentialCleanupCopy}>
                <Text style={styles.credentialCleanupTitle}>Eşleştirme kimliği temizliği</Text>
                <Text accessibilityLiveRegion="polite" style={styles.rowHint}>
                  {credentialRetryFailed
                    ? 'Temizlik hâlâ doğrulanamadı. Daha sonra yeniden deneyin.'
                    : pendingCredentialCount > 0
                      ? `Bu cihazdaki ${pendingCredentialCount} kimlik bilgisinin temizliği doğrulanamadı.`
                      : 'Bu cihazdaki temizlik durumu denetlenemedi. Güvenli olmak için yeniden deneyin.'}
                </Text>
              </View>
              <Pressable
                accessibilityRole="button"
                accessibilityLabel="Eşleştirme kimliklerini temizlemeyi yeniden dene"
                accessibilityState={{
        ...
        <View style={[styles.section, styles.sectionSpacer]}>
          <View style={styles.row}>
            ...
            <Text style={styles.rowLabel}>Gizlilik: veriler şirketinizin kurulumunda kalır</Text>
          </View>
          <View style={styles.separator} />
          <View style={styles.row}>
            <LifeBuoy size={16} color={colors.textSecondary} />
            <Text style={styles.rowLabel}>Destek: şirket yöneticinizle iletişime geçin</Text>
          </View>
        </View>
      </ScrollView>
    </View>
