...
const LINK_MODE_OPTIONS: PickerOption<MobileTerminalLinkOpenMode>[] = [
  {
    value: 'orca-browser',
    label: 'Masaüstündeki BarkOS tarayıcısı',
    subtitle: 'Eşleştirilmiş bilgisayarınızdaki aktarılan tarayıcıda açın.'
  },
  {
    value: 'phone-browser',
    label: 'Telefon tarayıcısı',
    subtitle: 'Bu telefondaki Safari, Chrome veya başka bir tarayıcıda açın.'
  }
]
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      <View style={styles.topRow}>
        ...
        <Text style={styles.heading}>Tarayıcı</Text>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.groupHeading}>BAĞLANTILAR</Text>
        <Text style={styles.groupDescription}>
          Terminal çıktısındaki HTTP(S) bağlantılarının nerede açılacağını seçin.
        </Text>
        <View style={[styles.section, styles.sectionTopGap]}>
          ...
          >
            ...
            <View style={styles.rowContent}>
              <Text style={styles.rowLabel}>Terminal bağlantılarını aç</Text>
      ...
      <PickerModal<MobileTerminalLinkOpenMode>
        visible={pickerOpen}
        title="Terminal bağlantılarını aç"
