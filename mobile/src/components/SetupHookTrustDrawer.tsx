...
// The repo-owned barkos.yaml setup-hook trust prompt, shown before a workspace
        ...
        <View>
          <View style={styles.trustHeader}>
            ...
            <Text style={styles.subtitle}>
              This repository's barkos.yaml runs before the workspace starts. Only run it if you
