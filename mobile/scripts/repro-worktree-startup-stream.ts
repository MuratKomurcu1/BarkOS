...
const USER_DATA =
  process.env.ORCA_USER_DATA ?? `${process.env.HOME}/Library/Application Support/barkos-dev`
...
const devices = readJson<Array<{ token: string }>>(join(USER_DATA, 'barkos-devices.json'))
