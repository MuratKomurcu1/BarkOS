...
Engage BarkOS's computer-use surface whenever you must inspect or operate a local desktop app
...
windows, webviews, and BarkOS's own UI. Triggers include "computer use", "orca computer",
