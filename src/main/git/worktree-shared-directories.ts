...
// duplicates disk; `barkos.yaml` names the ones every worktree should share instead.
 ...
 *  Shared Paths setting plus the repo's `barkos.yaml` shared directories.
 *
...
/** Resolve `worktree.sharedDirectories` from the repo-root `barkos.yaml` to
