...
export class DroidHookService {
  async refreshManagedScripts(): Promise<void> {
    await refreshManagedScriptIfPresent(getManagedScriptPath(), getDroidManagedHookScript())
  }
  ...
  install(): AgentHookInstallStatus {
    ...
    writeManagedScript(scriptPath, getDroidManagedHookScript())
  ...
  async installRemote(sftp: SFTPWrapper, remoteHome: string): Promise<AgentHookInstallStatus> {
    ...
    try {
      ...
      await writeManagedScriptRemote(sftp, remoteScriptPath, getDroidManagedHookScript('posix'))
