...
const BARKOS_RELEASES_URL = 'https://github.com/MuratKomurcu1/BarkOS'
const ATOM_FEED_URL = `${BARKOS_RELEASES_URL}/releases.atom`
const RELEASES_DOWNLOAD_BASE = `${BARKOS_RELEASES_URL}/releases/download`
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/MuratKomurcu1\/BarkOS\/releases\/tag\/([^"]+)"/gi
