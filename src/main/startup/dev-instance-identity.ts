...
import { BARKOS_APP_ID, BARKOS_PRODUCT_NAME } from '../../shared/barkos/product-identity'

const BASE_APP_NAME = BARKOS_PRODUCT_NAME
const BASE_APP_USER_MODEL_ID = BARKOS_APP_ID
...
export function getDevInstanceIdentity(
  ...
  return {
    name: dockTitle,
    // Why: one stable Keychain key for all BarkOS dev
