...
export function configureDevUserDataPath(isDev: boolean): void {
  ...
  // Why: BarkOS development state must not overwrite either packaged BarkOS or an installed Orca profile.
  app.setPath('userData', join(app.getPath('appData'), 'barkos-dev'))
}
