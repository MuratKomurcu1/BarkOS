...
import watercolorIcon from '../../resources/app-icons/barkos-watercolor.png?asset'
import watercolorMacDockIcon from '../../resources/app-icons/barkos-watercolor.png?asset&asarUnpack'
import blueIcon from '../../resources/app-icons/barkos-blue.png?asset'
import blueMacDockIcon from '../../resources/app-icons/barkos-blue.png?asset&asarUnpack'
...
const MAC_DOCK_ICON_SCRIPT = [
  ...
  'if image is missing value then error "BarkOS app icon image could not be loaded"',
  "set ok to current application's NSWorkspace's sharedWorkspace()'s setIcon:image forFile:appPath options:0",
  'if ok is false then error "BarkOS app icon could not be persisted"'
]
...
const MAC_DOCK_ICON_CLEAR_SCRIPT = [
  ...
  'if ok is false then error "BarkOS app icon could not be cleared"'
]
