...
export function markCodexProjectTrusted(workspacePath: string): void {
  markCodexProjectTrustedInHome(workspacePath, join(homedir(), '.codex'))
  ...
  markCodexProjectTrustedInHome(workspacePath, getOrcaManagedCodexHomePath())
}

export function markCodexProjectTrustedInHome(workspacePath: string, codexHomePath: string): void {
