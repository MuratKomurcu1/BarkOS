...
export const openCodeIsPluginInstalledMock: Mock = vi.fn(() => true)
...
export const openCodeHookServiceModuleMock = () => ({
  openCodeHookService: {
    ...
    isPluginInstalledIn: openCodeIsPluginInstalledMock,
...
export const linuxCliShimModuleMock = () => ({
  ensureLinuxTerminalBarkosCliShimDir: (options: { userDataPath: string }) =>
    join(options.userDataPath, 'linux-barkos-cli-shim')
})
