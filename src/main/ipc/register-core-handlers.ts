...
import { registerBarkosBundledSkillsHandlers } from './barkos-bundled-skills'
...
import { registerVoiceAssistantHandlers } from './voice-assistant'
...
export function registerCoreHandlers(
  ...
  registerBarkosBundledSkillsHandlers()
  registerBarkosDecisionInboxHandlers(runtime)
  registerBarkosMemoryVaultHandlers()
  registerBarkosProviderCapacityHandlers()
  registerBarkosUsageCostHandlers({ claudeUsage, codexUsage })
  registerBarkosWorkerSessionHandlers()
  registerBarkosWorkLedgerHandlers(store)
  ...
  registerVoiceAssistantHandlers(store)
}
