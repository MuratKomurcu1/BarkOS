...
import { isMultiProfileUiEnabled } from '../barkos-profiles/profile-ui-scope'
import { transferOrcaProfileProject } from '../barkos-profiles/profile-project-transfer'
import { findOrcaProfileProjectsByPath } from '../barkos-profiles/profile-project-presence'
import { flushActiveProfileBeforeFileMutation } from '../barkos-profiles/profile-persistence-deadline'
...
} from '../barkos-profiles/profile-cloud-service'
...
async function runBeforeProfileRelaunch(
  ...
  try {
    ...
    console.warn(
      '[barkos-profiles] Pre-relaunch cleanup failed; continuing profile switch:',
