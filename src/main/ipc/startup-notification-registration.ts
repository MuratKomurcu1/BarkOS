...
export function triggerStartupNotificationRegistration(store: Store): void {
  ...
  const notification = new Notification({
    title: translateMain('notifications.permission.readyTitle', 'BarkOS is ready to notify you'),
    body: translateMain(
      'notifications.permission.readyBody',
      'Allow notifications so BarkOS can alert you when agents finish or terminals need attention.'
    )
  })
