...
const {
  ...
  registerBarkosCompanyHandlersMock,
  registerBarkosControlPolicyHandlersMock,
  registerBarkosBundledSkillsHandlersMock,
  registerBarkosDecisionInboxHandlersMock,
  registerBarkosMemoryVaultHandlersMock,
  registerBarkosProviderCapacityHandlersMock,
  registerBarkosUsageCostHandlersMock,
  registerBarkosWorkerSessionHandlersMock,
  registerBarkosWorkLedgerHandlersMock,
  ...
  registerBarkosCompanyHandlersMock: vi.fn(),
  registerBarkosControlPolicyHandlersMock: vi.fn(),
  registerBarkosBundledSkillsHandlersMock: vi.fn(),
  registerBarkosDecisionInboxHandlersMock: vi.fn(),
  registerBarkosMemoryVaultHandlersMock: vi.fn(),
  registerBarkosProviderCapacityHandlersMock: vi.fn(),
  registerBarkosUsageCostHandlersMock: vi.fn(),
  registerBarkosWorkerSessionHandlersMock: vi.fn(),
  registerBarkosWorkLedgerHandlersMock: vi.fn(),
...
vi.mock('./barkos-company', () => ({
  registerBarkosCompanyHandlers: registerBarkosCompanyHandlersMock
}))

vi.mock('./barkos-control-policy', () => ({
  registerBarkosControlPolicyHandlers: registerBarkosControlPolicyHandlersMock
}))

vi.mock('./barkos-bundled-skills', () => ({
  registerBarkosBundledSkillsHandlers: registerBarkosBundledSkillsHandlersMock
}))

vi.mock('./barkos-decision-inbox', () => ({
  registerBarkosDecisionInboxHandlers: registerBarkosDecisionInboxHandlersMock
}))

vi.mock('./barkos-memory-vault', () => ({
  registerBarkosMemoryVaultHandlers: registerBarkosMemoryVaultHandlersMock
}))

vi.mock('./barkos-provider-capacity', () => ({
  registerBarkosProviderCapacityHandlers: registerBarkosProviderCapacityHandlersMock
}))

vi.mock('./barkos-usage-cost', () => ({
  registerBarkosUsageCostHandlers: registerBarkosUsageCostHandlersMock
}))

vi.mock('./barkos-worker-sessions', () => ({
  registerBarkosWorkerSessionHandlers: registerBarkosWorkerSessionHandlersMock
}))

vi.mock('./barkos-work-ledger', () => ({
  registerBarkosWorkLedgerHandlers: registerBarkosWorkLedgerHandlersMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerBarkosCompanyHandlersMock.mockReset()
    registerBarkosControlPolicyHandlersMock.mockReset()
    registerBarkosBundledSkillsHandlersMock.mockReset()
    registerBarkosDecisionInboxHandlersMock.mockReset()
    registerBarkosMemoryVaultHandlersMock.mockReset()
    registerBarkosProviderCapacityHandlersMock.mockReset()
    registerBarkosUsageCostHandlersMock.mockReset()
    registerBarkosWorkerSessionHandlersMock.mockReset()
    registerBarkosWorkLedgerHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', async () => {
    ...
    expect(registerBarkosCompanyHandlersMock).toHaveBeenCalled()
    expect(registerBarkosControlPolicyHandlersMock).toHaveBeenCalled()
    expect(registerBarkosDecisionInboxHandlersMock).toHaveBeenCalledWith(runtime)
    expect(registerBarkosMemoryVaultHandlersMock).toHaveBeenCalled()
    expect(registerBarkosProviderCapacityHandlersMock).toHaveBeenCalled()
    expect(registerBarkosUsageCostHandlersMock).toHaveBeenCalledWith({
      claudeUsage,
      codexUsage
    })
    expect(registerBarkosWorkerSessionHandlersMock).toHaveBeenCalled()
    expect(registerBarkosWorkLedgerHandlersMock).toHaveBeenCalled()
