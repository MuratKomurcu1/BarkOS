...
import { barkosStaffingProposalSchema } from '../../../shared/barkos/staffing-proposal'
...
function reconcileWorkerDoneMessage(
  ...
  const filesModified =
    ...
    payload.filesModified.every((file) => typeof file === 'string')
      ...
      : []
  const staffingProposal = barkosStaffingProposalSchema.safeParse(payload.staffingProposal)
  ...
  const result = JSON.stringify({
    ...
    staffingProposal: staffingProposal.success ? staffingProposal.data : null,
