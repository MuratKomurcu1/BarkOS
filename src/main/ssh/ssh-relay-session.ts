...
export class SshRelaySession {
  ...
  private muxAgentHookRequestCleanup: (() => void) | null = null
  ...
  private wireUpAgentHookEvents(mux: SshChannelMultiplexer): void {
    ...
    this.muxAgentHookRequestCleanup?.()
    this.muxAgentHookRequestCleanup = mux.onRequest(
      AGENT_HOOK_EVALUATE_SIDE_EFFECT_METHOD,
      (params) => agentHookServer.evaluateRemoteToolUse(params, this.targetId)
    )
  ...
  private teardownProviders(
    ...
    this.muxAgentHookRequestCleanup?.()
    this.muxAgentHookRequestCleanup = null
