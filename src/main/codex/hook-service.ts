...
export function getCodexManagedHookInstallMaterial(): CodexManagedHookInstallMaterial {
  ...
  return {
    ...
    script: getCodexManagedHookScript()
  }
}
...
function installManagedHooksIntoWslRuntime(
  ...
  writeManagedScript(plan.scriptPath, getCodexManagedHookScript('posix'))
...
export class CodexHookService {
  async refreshManagedScripts(): Promise<void> {
    await refreshManagedScriptIfPresent(getManagedScriptPath(), getCodexManagedHookScript())
  }
  ...
  install(runtimeHomePath: string = getOrcaManagedCodexHomePath()): AgentHookInstallStatus {
    ...
    config.hooks = nextHooks
    writeManagedScript(scriptPath, getCodexManagedHookScript())
  ...
  async installRemote(
    ...
    try {
      ...
      await writeManagedScriptRemote(sftp, remoteScriptPath, getCodexManagedHookScript('posix'))
...
export const _internals = {
  getManagedScript: getCodexManagedHookScript,
