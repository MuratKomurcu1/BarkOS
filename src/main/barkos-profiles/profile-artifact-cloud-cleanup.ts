...
import type { OrcaProfileCloudSummary, OrcaProfileSummary } from '../../shared/barkos-profiles'
...
function assertArtifactCloudCleanupReady(
  ...
  if (
    ...
    throw new Error('The BarkOS profile transition must be retried before publishing artifacts.')
  }
}
