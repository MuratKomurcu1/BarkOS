...
import type { OrcaCloudCapabilities, OrcaCloudOrgSummary } from '../../shared/barkos-profiles'
...
export function createDevOrcaCloudSession(
  ...
  return {
    ...
    cloud: {
      ...
      displayName: cleanEnvString(process.env.ORCA_CLOUD_DEV_DISPLAY_NAME, 'BarkOS Dev'),
