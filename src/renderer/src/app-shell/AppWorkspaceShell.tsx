...
const BarkosCompanyPage = lazy(() => import('../components/barkos-company/BarkosCompanyPage'))
...
function ActivePage({ layout }: { layout: AppChromeLayout }): React.JSX.Element {
  ...
  return (
    <>
      ...
      {activeView === 'company' ? <BarkosCompanyPage /> : null}
                ...
                <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                  ...
                  <Suspense fallback={null}>
                    <RecoverableRenderErrorBoundary
                      ...
                      description={translate(
                        'auto.App.03a14f6b5b',
                        'Sayfayı yeniden deneyin veya başka bir BarkOS bölümüne geçin.'
                      )}
                    >
