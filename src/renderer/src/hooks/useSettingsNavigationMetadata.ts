  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Coordinate multiple coding agents through BarkOS.'
      ),
      icon: Network,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'How Linear works in BarkOS, setup checklist, agent skill, and example prompts.'
            ),
            icon: LinearIcon,
    ...
    ...(showDesktopOnlySettings
      ? [
          {
            id: 'orca-account',
            title: translate('auto.components.settings.orcaAccount.title', 'BarkOS Account'),
            description: translate(
              'auto.components.settings.orcaAccount.description',
              'Share work instantly and reach your desktop from BarkOS Mobile wherever you are.'
            ),
      ...
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core BarkOS workflows.'
      ),
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'Configure mobile emulator support for BarkOS and coding agents.'
            ),
    ...
    },
    {
      ...
      description: translate(
        ...
        'BarkOS stats plus Claude, Codex, OpenCode token analytics and Grok subscription usage.'
      ),
      icon: BarChart3,
      ...
      : []),
    {
      ...
      title: translate(
        ...
        'Remote BarkOS Servers'
      ),
      description: isWebClient
        ? 'Connect this browser to a saved BarkOS server.'
        : 'Pair remote BarkOS runtimes for persistent sessions, richer remote state, and web or mobile handoff.',
      icon: Server,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'Install and manage experimental BarkOS plugins.'
            ),
            icon: Blocks,
