...
it('connects the notice to the macOS prompt and keeps it open until closed', async () => {
  ...
  expect(toastWarning).toHaveBeenCalledWith(
    'Seeing “BarkOS would like to access…” prompts?',
    expect.objectContaining({
      description:
        'Permission messages from macOS may appear when an agent or terminal tool running in BarkOS attempts to access protected files. Grant Full Disk Access in Settings to reduce these prompts.'
    })
  )
