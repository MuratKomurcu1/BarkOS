...
} from './barkos-profiles-auth-actions'
...
export const createOrcaProfilesSlice: StateCreator<AppState, [], [], OrcaProfilesSlice> = (
  ...
  fetchOrcaProfiles: async () => {
    ...
    try {
      ...
      console.error('Failed to fetch BarkOS profiles:', err)
  ...
  fetchOrcaProfileAuthStatus: async () => {
    try {
      ...
      console.error('Failed to fetch BarkOS profile auth status:', err)
      return null
    }
  },
  ...
  createLocalOrcaProfile: async (name) => {
    try {
      ...
      console.error('Failed to create BarkOS profile:', err)
      toast.error(
  ...
  switchOrcaProfile: async (profileId) => {
    ...
    try {
      ...
      console.error('Failed to switch BarkOS profile:', err)
      set({ orcaProfileSwitching: false })
      toast.error(
  ...
  transferOrcaProfileProject: async (args) => {
    try {
      ...
      console.error('Failed to transfer BarkOS profile project:', err)
      toast.error(
