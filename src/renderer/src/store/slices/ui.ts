...
export type UISlice = {
  ...
  previousViewBeforeCompany: Exclude<TopLevelView, 'company'>
...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  previousViewBeforeCompany: 'terminal',
  ...
  openCompanyPage: () =>
    set((state) => ({
      activeView: 'company',
      previousViewBeforeCompany:
        state.activeView === 'company' ? state.previousViewBeforeCompany : state.activeView
    })),
  closeCompanyPage: () =>
    set((state) => ({
      activeView: state.previousViewBeforeCompany
    })),
  openSpacePage: () => {
