...
import { localizeFeatureTip } from './localized-feature-tip'
...
export default function FeatureTipsModal(): JSX.Element | null {
  ...
  const currentTip = localizeFeatureTip(
    ...
    switch (currentTip.action) {
      ...
      case 'setup-cli': {
        ...
        try {
          ...
          const message = error instanceof Error ? error.message : 'Failed to install BarkOS CLI.'
          if (
            import.meta.env.DEV &&
