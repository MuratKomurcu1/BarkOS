...
const CLI_AGENT_COMMANDS = [
  'barkos worktree create --name auth-pr-1',
  'barkos worktree create --name auth-pr-2',
  'barkos orchestration dispatch --task pr1 --to w1',
  'barkos orchestration dispatch --task pr2 --to w2'
]
