...
export const STARTUP_CWD_FALLBACK_NOTICE =
  '\r\n[BarkOS opened this terminal at the workspace root because its saved start folder no longer exists.]\r\n'
...
const HIDDEN_OUTPUT_RESTORE_UNAVAILABLE_WARNING =
  '\r\n[BarkOS skipped hidden terminal output because main recovery was unavailable.]\r\n'
