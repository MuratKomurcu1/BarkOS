...
function getStepTooltipLabel(stepId: keyof typeof stepCopy): string {
  const labels = {
    agent: translate('barkos.onboarding.step.agent', 'Default agent'),
    theme: translate('barkos.onboarding.step.theme', 'Appearance'),
    windows_terminal: translate('barkos.onboarding.step.windowsTerminal', 'Windows terminal'),
    notifications: translate('barkos.onboarding.step.notifications', 'Notifications'),
    integrations: translate('barkos.onboarding.step.integrations', 'Integrations')
  }
...
export default function OnboardingFlow({
  ...
  const footerPrimaryLabel =
    ...
    (currentStep.id === 'notifications'
      ? translate('barkos.onboarding.addFirstProject', 'Add your first project')
      : translate('barkos.onboarding.continue', 'Continue'))
                    ...
                    <TooltipTrigger asChild>
                      <button
                        ...
                        aria-label={translate(
                          ...
                          { value0: progressIdx + 1, value1: getStepTooltipLabel(step.id) }
                        )}
