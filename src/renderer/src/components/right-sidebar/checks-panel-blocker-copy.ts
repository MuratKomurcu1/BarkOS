...
> = {
  ...
  fork_head_unsupported: {
    ...
    body: {
      ...
      fallback: 'BarkOS cannot create a {{reviewLabel}} from this fork head here.'
    }
  },
  base_not_on_remote: {
    title: {
  ...
  unsupported_provider: {
    ...
    body: {
      ...
      fallback: 'This repository provider does not support creating a {{reviewLabel}} from BarkOS.'
    }
  }
}
  ...
  if (reason === 'existing_review') {
    ...
    return {
      ...
      description: translate(
        ...
        'BarkOS found an existing {{reviewLabel}} for this branch.',
        { reviewLabel }
      ),
      composerMode: 'hidden',
      workflowAction: null,
...
> = {
  ...
  auth_required: {
    ...
    body: {
      ...
      fallback:
        '{{provider}} must be connected in this environment before BarkOS can create a {{reviewLabel}}.'
    },
    workflow: null
  }
}
