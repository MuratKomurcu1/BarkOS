...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/barkos-cli',
    resolvedPath: '/home/.agents/skills/barkos-cli',
    physicalIdentity: 'physical-barkos-cli',
...
const DISMISSAL_KEY = ['physical-barkos-cli', 'barkos-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/barkos-cli',
          resolvedPath: '/home/projects/work/.agents/skills/barkos-cli',
          physicalIdentity: 'physical-repo-barkos-cli'
        })
      ],
      eligibleUpdateNames: ['barkos-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-barkos-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['barkos-cli'],
      scanIssues: [],
