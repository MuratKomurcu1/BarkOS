...
import type { OrcaHooks, SetupAgentStartupPolicy } from '../../../shared/barkos-yaml-hook-types'
...
function SetupCommandPreview({ setupConfig }: { setupConfig: SetupConfig }): React.JSX.Element {
  // Why: just the script in a quiet monochrome card — the source label (barkos.yaml / local) and
              ...
              {setupControlsEnabled && setupConfig ? (
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    {/* Why: a quiet monospace filename chip (not an uppercase tag) — barkos.yaml is a
                  ...
                  {/* Why: `barkos.yaml` is the committed source of truth for shared setup,
