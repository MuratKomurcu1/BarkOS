        ...
        >
          <div className="mp-step2-layout">
            <div className="mp-step2-copy">
              ...
              <h2 className="mp-h2">
                {translate('auto.components.mobile.MobileHero.0d9b33299e', 'Get BarkOS Mobile.')}
              </h2>
              <p className="mp-lead-sm">
                {translate(
                  'auto.components.mobile.MobileHero.e75647ace0',
                  'Use only a BarkOS Mobile build published for your company.'
                )}
              </p>
              ...
              {installCopy.url ? (
                ...
                <div className="rounded-lg border border-border bg-muted/25 p-4 text-sm">
                  <p className="font-medium text-foreground">
                    {translate('barkos.mobile.private.title', 'BarkOS Mobile private distribution')}
                  </p>
                  <p className="mt-1 text-muted-foreground">
                    {translate(
                      'barkos.mobile.private.description',
                      'The previous store build has been removed. A BarkOS install link will appear here only after the BarkOS mobile build is signed and published.'
                    )}
                  </p>
                </div>
              )}
            ...
            <div className="mp-qr mp-qr-large">
              {installQrUrl ? (
                ...
                <div className="flex h-full min-h-56 items-center justify-center p-6 text-center text-sm text-muted-foreground">
                  {translate(
                    'barkos.mobile.private.noQr',
                    'No external install QR is published for BarkOS Mobile yet.'
                  )}
                </div>
              )}
            </div>
