...
describe('OrcaProfileSignOutConfirmDialog', () => {
  it('describes account sign-out without presenting a local profile or warning', () => {
    ...
    expect(html).toContain('Sign out of BarkOS?')
    expect(html).toContain(
      'Artifacts and BarkOS Relay will be unavailable until you sign in again. Your local projects and worktrees won&#x27;t be affected.'
    )
