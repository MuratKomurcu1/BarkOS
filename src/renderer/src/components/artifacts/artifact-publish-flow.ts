    ...
    for (let attempt = 0; attempt < 2; attempt += 1) {
      ...
      toast.error(
        translate(
          ...
          'Sign in to BarkOS and try again.'
        )
      )
      return null
    }
  ...
  switch (code) {
    ...
    case 'too-large':
      return translate(
        ...
        'Artifacts shared from BarkOS must be smaller than 800 KB.'
      )
    case 'unreadable':
      return translate(
        'auto.components.artifacts.artifact-publish-flow.e2ed5acd8c',
        "BarkOS couldn't read this file. Open it from a workspace and try again."
      )
    case 'unsupported':
      return translate(
