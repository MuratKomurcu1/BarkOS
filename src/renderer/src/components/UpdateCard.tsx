      ...
      ? isLocalBuild
        ...
        : isHttp2UpdateError
          ? {
              ...
              summary: 'BarkOS can retry through HTTP/1.1 compatibility mode.',
              explainer: translate(
          ...
          : isSignatureMismatchError
            ? {
                ...
                summary: translate(
                  ...
                  "The installer's publisher doesn't match BarkOS, so we stopped the update. Don't install this download; check official releases for a corrected version."
                ),
                detail: status.message,
...
function SimpleCardContent({
  ...
  return (
    <div className="flex flex-col gap-2.5 p-3.5">
      ...
      <p className="text-sm text-muted-foreground">
        {translate('auto.components.UpdateCard.05ad78a6d1', 'BarkOS v{{value0}} is ready.', {
          value0: version
        })}
      </p>
      ...
      <p className="text-sm text-muted-foreground">
        {release
          ...
          : translate(
              ...
              'BarkOS v{{value0}} is downloading.',
              {
                value0: version
              }
            )}
    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {translate(
          ...
          "BarkOS v{{value0}} is downloaded. Restart when you're ready.",
          { value0: version }
        )}
      </p>
