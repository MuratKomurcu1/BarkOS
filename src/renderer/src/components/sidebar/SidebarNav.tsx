...
const SidebarNav = React.memo(function SidebarNav() {
  ...
  const openCompanyPage = useAppStore((s) => s.openCompanyPage)
  ...
  const companyActive = activeView === 'company'
  ...
  return (
    ...
    >
      ...
      >
        <Building2
          className={cn('size-4 shrink-0', !companyActive && 'text-worktree-sidebar-foreground/30')}
          strokeWidth={companyActive ? 2.25 : 1.75}
        />
        <span className="flex-1">
          {translate('barkos.components.sidebar.SidebarNav.company', 'Company')}
        </span>
      </button>
      {showArtifactsButton ? (
        <ContextMenu>
            ...
            >
              ...
              >
                ...
                <span className="min-w-0 flex-1 truncate">
                  {translate('auto.components.sidebar.SidebarNav.1b5c41caee', 'BarkOS Mobile')}
                </span>
