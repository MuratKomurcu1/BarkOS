...
describe('SidebarSettingsHelpMenu', () => {
  ...
  it('does not render the inherited onboarding menu item', () => {
    const html = renderToStaticMarkup(<SidebarSettingsHelpMenu />)
    expect(html).not.toContain('Onboarding')
  })

  it('renders Restart BarkOS by default', () => {
    const html = renderToStaticMarkup(<SidebarSettingsHelpMenu />)
    expect(html).toContain('Restart BarkOS')
  })

  it('does not expose inherited Orca support channels', () => {
    const html = renderToStaticMarkup(<SidebarSettingsHelpMenu />)
