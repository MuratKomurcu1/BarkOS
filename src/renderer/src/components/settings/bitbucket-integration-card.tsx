    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Configured via environment variables. Unset the ORCA_BITBUCKET_* variables to manage this credential in BarkOS.'
        )}
      </p>
    )
  }
      ...
      <p className="text-xs text-muted-foreground">
        {props.storedCredential
          ...
          : translate(
              ...
              'Bitbucket credentials are configured but could not authenticate. Check the token and repository permissions, then restart BarkOS if environment variables changed.'
            )}
      </p>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Saved in BarkOS on this machine. ORCA_BITBUCKET_* environment variables take precedence when set.'
        )}
      </p>
    )
  }
