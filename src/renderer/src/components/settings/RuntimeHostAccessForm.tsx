        ...
        <ol className="ml-4 list-decimal space-y-1 text-xs text-muted-foreground">
          <li>
            {translate(
              ...
              'Open Settings → Remote BarkOS Servers → Share this host.'
            )}
          </li>
          <li>
            {translate(
          ...
          <li>
            {translate(
              ...
              'Generate the link, then copy the “Pair another BarkOS client” link.'
            )}
          </li>
        </ol>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,180px)_minmax(0,1fr)]">
        <div className="space-y-2">
          <Label htmlFor="runtime-server-name">
            {translate('auto.components.settings.RuntimeHostAccessForm.name', 'Name in BarkOS')}
          </Label>
          <Input
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'This only changes how the computer appears in BarkOS.'
            )}
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p id="runtime-server-access-link-help" className="text-xs text-muted-foreground">
            {translate(
              ...
              'BarkOS shows the destination before connecting. Credentials stay hidden.'
            )}
          </p>
          {inputError ? (
          ...
          <div className="text-sm font-medium text-destructive">
            {failure.kind === 'host-identity-mismatch'
              ? translate(
                  ...
                  'The reached BarkOS host does not match this access link'
                )
              : failure.kind === 'access-link-invalid'
                ...
                : failure.kind === 'protocol-incompatible'
                  ? translate(
                      ...
                      'BarkOS versions are not compatible'
                    )
        ...
        {parsed.ok && parsed.value.endpointKind === 'loopback' ? (
          ...
          <p className="mt-2 text-muted-foreground">
            {translate(
              ...
              'Using headless barkos serve? Run barkos serve --pairing-address <reachable-host> on the other computer.'
            )}
          </p>
        )}
      </details>
