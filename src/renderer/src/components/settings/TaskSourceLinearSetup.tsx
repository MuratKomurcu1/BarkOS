      ...
      <ol className="divide-y divide-border/50">
        <TaskSourceStepRow
          ...
          description={translate(
            ...
            'Add a Personal API key so BarkOS can browse issues and open workspaces with ticket context.'
          )}
          action={
            <Button
              type="button"
        ...
        <TaskSourceStepRow
          ...
          description={translate(
            ...
            'Gives agents /barkos-linear to read tickets, post updates, move states, and attach pull or merge requests.'
          )}
