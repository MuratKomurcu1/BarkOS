    ...
    <section className="space-y-3">
      <div className="flex items-start justify-between gap-3">
        <SettingsSubsectionHeader
          title={translate('auto.components.settings.DevToolsPane.orcaCloud', 'BarkOS Cloud')}
          description={translate(
        ...
        <p className="text-xs text-muted-foreground">
          {authStatus?.setupMessage ??
            translate(
              ...
              'Set ORCA_CLOUD_API_URL and ORCA_CLOUD_CLIENT_ID to preview BarkOS Cloud sign-in in this dev build.'
            )}
        </p>
      )}
    </section>
