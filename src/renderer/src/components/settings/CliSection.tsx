    ...
    <section className="space-y-4" data-settings-section="cli">
      <div className="space-y-1">
        <h2 className="text-sm font-semibold">
          {translate('auto.components.settings.CliSection.c5c0f2641d', 'BarkOS CLI')}
        </h2>
        <p className="text-xs text-muted-foreground">
          {translate(
            'auto.components.settings.CliSection.6930feda9e',
            'Use BarkOS from your terminal to open the app, manage worktrees, and interact with BarkOS terminals.'
          )}
        </p>
      </div>
          ...
          <div className="border-t border-border/60 pt-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Give agents BarkOS-aware workspace, terminal, and progress workflows.'
                )}
              </p>
            </div>
            ...
            <AgentSkillSetupPanel
              ...
              description={translate(
                ...
                'Enables agents to use BarkOS workspace, terminal, and progress commands.'
              )}
