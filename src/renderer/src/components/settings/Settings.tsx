              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Optional. BarkOS works with your existing provider logins; add accounts only if you want BarkOS to help switch between them.'
                  )}
                  badge={translate(
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Finish the core workflows that make BarkOS useful for parallel agent work.'
                  )}
