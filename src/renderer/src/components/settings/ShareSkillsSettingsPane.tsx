    ...
    <div className="divide-y divide-border">
      <section className="space-y-2 py-5 first:pt-0">
        ...
        <p className="text-xs leading-relaxed text-muted-foreground">
          {translate(
            ...
            'Shared bundles are not searchable or listed in BarkOS. The link is the credential, so send it only to people you trust.'
          )}
        </p>
      </section>
      ...
      <SettingsSwitchRow
        label={translate(
          ...
          'Allow agents and the BarkOS CLI to publish skill links'
        )}
        description={
          isWebClient
            ? translate(
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              {isWebClient
                ? translate(
                    ...
                    'Publishing and link management are available in the BarkOS desktop app.'
                  )
                : translate(
                    'auto.components.settings.shareSkills.signInDescription',
                    'Use your BarkOS account to publish bundles and manage their links. Recipients do not need an account.'
                  )}
            </p>
          </div>
          {!isWebClient ? (
            ...
            >
              {connecting
                ...
                : authStatus?.state === 'reconnect-required'
                  ...
                  : translate('auto.components.settings.shareSkills.signIn', 'Sign in to BarkOS')}
            </Button>
          ) : null}
        </section>
      ) : null}
