        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {translate(
              ...
              'Marketplaces are pinned Git repositories. BarkOS uses your existing system Git credentials for private repositories.'
            )}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Use an HTTPS or SSH repository URL containing barkos-marketplace.json.'
              )}
            </p>
          </div>
          <Input
