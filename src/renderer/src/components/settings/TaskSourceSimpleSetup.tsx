...
export function CodeHostSetupSteps(
  ...
  const connectionDescription = props.unavailable
    ? translate(
        ...
        "BarkOS couldn't check this connection. Try again, or open Integrations for setup details."
      )
    : translate(
        'auto.components.settings.TasksPane.connectCodeHostDescription',
        'Install and authenticate the CLI under Integrations so BarkOS can load issues.'
      )
