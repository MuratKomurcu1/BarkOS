...
export function getAgentAwakeDescription(
  ...
  return translate(
    ...
    'Choose On, Agent, or Off. Agent mode stays awake while agents are working. BarkOS also asks this device to stay awake when the lid is closed, subject to its power policy.'
  )
}
