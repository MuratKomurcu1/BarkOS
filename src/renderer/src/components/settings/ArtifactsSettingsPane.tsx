...
export function ArtifactsSettingsPane({
  ...
  const howToSteps: HowToStep[] = [
      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the BarkOS desktop app on the host device and enable publishing.'
                )
              : translate(
    ...
    {
      key: 'manage',
      title: translate('auto.components.settings.artifacts.manageStepTitle', 'Manage it in BarkOS'),
      description: translate(
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              {translate(
                ...
                'Use your BarkOS account to upload artifacts and manage their public links.'
              )}
            </p>
          </div>
          <Button
          ...
          >
            {connecting
              ...
              : authStatus?.state === 'reconnect-required'
                ...
                : translate('auto.components.settings.artifacts.signIn', 'Sign in to BarkOS')}
          </Button>
        </section>
      ) : null}
