      ...
      void preparation
        .then((result) => {
          ...
          if (!startup) {
            ...
            throw new Error(
              result.substituteCodexHome
                ? 'This session was dragged from an older BarkOS window, so BarkOS cannot retarget it to the selected Codex account. Resume it from the Session History panel instead.'
                : 'BarkOS could not prepare this legacy Codex session. Retry resume.'
            )
          }
