...
export function hookBodyPayloadRecord(body: unknown): Record<string, unknown> | null {
...
export function hookBodyHasBarkosSideEffectEnforcement(body: unknown): boolean {
  if (typeof body !== 'object' || body === null || Array.isArray(body)) {
    return false
  }
