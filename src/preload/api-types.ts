...
import type { BarkosCompanyApi } from './api/barkos-company-api'
import type { BarkosControlPolicyApi } from './api/barkos-control-policy-api'
import type { BarkosBundledSkillsApi } from './api/barkos-bundled-skills-api'
import type { BarkosDecisionInboxApi } from './api/barkos-decision-inbox-api'
import type { BarkosMemoryVaultApi } from './api/barkos-memory-vault-api'
import type { BarkosProviderCapacityApi } from './api/barkos-provider-capacity-api'
import type { BarkosUsageCostApi } from './api/barkos-usage-cost-api'
import type { BarkosWorkerSessionApi } from './api/barkos-worker-session-api'
import type { BarkosWorkLedgerApi } from './api/barkos-work-ledger-api'
...
import type { VoiceAssistantApi } from './api/voice-assistant-api'
...
export type PreloadApi = {
  ...
  barkosCompany: BarkosCompanyApi
  barkosControlPolicy: BarkosControlPolicyApi
  barkosBundledSkills: BarkosBundledSkillsApi
  barkosDecisionInbox: BarkosDecisionInboxApi
  barkosMemoryVault: BarkosMemoryVaultApi
  barkosProviderCapacity: BarkosProviderCapacityApi
  barkosUsageCost: BarkosUsageCostApi
  barkosWorkerSessions: BarkosWorkerSessionApi
  barkosWorkLedger: BarkosWorkLedgerApi
  wsl: RuntimeApi['wsl']
  ...
  mobile: MobileApi
  speech: SpeechApi
  voiceAssistant: VoiceAssistantApi
}
