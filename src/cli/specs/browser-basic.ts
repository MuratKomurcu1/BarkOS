...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'barkos wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage:
      'barkos tab switch (--index <n> | --page <id>) [--worktree <selector>] [--focus] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'index', 'page', 'worktree', 'focus']
  },
  {
    path: ['tab', 'create'],
    summary: 'Create a new browser tab in the current worktree',
    usage: 'barkos tab create [--url <url>] [--worktree <selector>] [--profile <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'barkos tab profile list [--json]',
  ...
  },
  {
    ...
    usage:
      'barkos tab profile create --label <name> [--scope <isolated|imported>] [--no-ua-spoof] [--json]',
