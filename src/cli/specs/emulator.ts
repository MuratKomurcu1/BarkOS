...
export const EMULATOR_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['emulator', 'list'],
    summary: 'List available/running emulators (BarkOS-managed + raw serve-sim)',
    usage: 'barkos emulator list [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'devices'],
    summary: 'List all emulator devices/AVDs across iOS and Android',
    usage: 'barkos emulator devices [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['emulator', 'attach'],
    summary: 'Attach/start helper for a device and make it active for the worktree',
    usage: 'barkos emulator attach [device] [--worktree <selector>] [--focus] [--json]',
  ...
  },
  {
    ...
    usage: 'barkos emulator tap <x> <y> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'barkos emulator type <text> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: "barkos emulator gesture '<json>' [--device <id>] [--worktree <selector>] [--json]",
  ...
  },
  {
    ...
    usage: 'barkos emulator button <name> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage: 'barkos emulator rotate <orientation> [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    path: ['emulator', 'exec'],
    summary:
      'Raw passthrough (e.g. barkos emulator exec --command "tap 0.5 0.7" or "ca-debug blended on")',
    usage: 'barkos emulator exec --command <cmd> [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'command', 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'kill'],
    summary: 'Stop helper for device',
    usage: 'barkos emulator kill [--device <id>] [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'barkos emulator shutdown [--device <id>] [--emulator <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'install'],
    summary: 'Install an APK onto the target Android device',
    usage: 'barkos emulator install <apkPath> [--reinstall] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'barkos emulator launch <package> [--activity <name>] [--device <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'barkos emulator permissions <grant|revoke> <package> <permission> [--device <id>] [--json]\n       barkos emulator permissions reset [--device <id>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'device',
      'emulator',
  ...
  },
  {
    ...
    usage: 'barkos emulator ax [--device <id>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'device', 'emulator', 'worktree']
  },
  {
    path: ['emulator', 'logcat'],
    summary: 'Capture a one-shot logcat dump from the Android device',
    usage: 'barkos emulator logcat [--lines <n>] [--device <id>] [--worktree <selector>] [--json]',
