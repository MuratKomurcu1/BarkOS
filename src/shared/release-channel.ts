...
export const HOURLY_RELEASE_REPO = 'MuratKomurcu1/BarkOS'
export const DAILY_RELEASE_REPO = 'MuratKomurcu1/BarkOS'
export const ADHOC_RELEASE_REPO = 'MuratKomurcu1/BarkOS'
export const MAIN_RELEASE_REPO = 'MuratKomurcu1/BarkOS'
