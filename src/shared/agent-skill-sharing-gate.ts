...
export const AGENT_SKILL_SHARING_DISABLED_MESSAGE =
  'Publishing skill links from agents and the BarkOS CLI is off for this device.'

export const AGENT_SKILL_SHARING_DISABLED_NEXT_STEPS: readonly string[] = [
  'Open Settings → Share Skills in the BarkOS desktop app on this device.',
  'Turn on "Allow agents and the BarkOS CLI to publish skill links".',
