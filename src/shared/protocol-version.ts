...
export const FILE_MUTATION_OWNERSHIP_UPDATE_REQUIRED_MESSAGE =
  'Remote file changes require a newer BarkOS server. Update the HUB and try again.'
...
export const BARKOS_REMOTE_USAGE_COST_RUNTIME_CAPABILITY = 'barkos.remote-usage-cost.v1' as const
