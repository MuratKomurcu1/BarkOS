...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'BarkOS’s built-in prompt for this action, including the context BarkOS knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the BarkOS workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when BarkOS has one available.',
