...
export const DEFAULT_TUI_AGENT_ARGS: Partial<Record<TuiAgent, string>> = Object.fromEntries(
  Object.entries(YOLO_TUI_AGENT_ARGS).filter(
    ([agent, args]) => !hasUnsupportedTuiAgentArgs(agent as TuiAgent, args)
  )
)
