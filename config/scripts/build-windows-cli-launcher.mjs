...
if (process.platform !== 'win32') {
  ...
  // continue toward a Windows package whose declared barkos.exe does not exist.
  throw new Error(
...
if (!compilerPath) {
  throw new Error('Unable to find the .NET Framework C# compiler required for barkos.exe.')
}
...
function defaultOutputPath(projectRoot) {
  return join(projectRoot, 'native', 'windows-cli-launcher', '.build', 'barkos.exe')
}
