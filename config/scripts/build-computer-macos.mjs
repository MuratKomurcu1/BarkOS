...
const binaryPath = path.join(packagePath, '.build', 'release', 'barkos-computer-use-macos')
const appPath = path.join(packagePath, '.build', 'release', 'BarkOS Computer Use.app')
const appExecutablePath = path.join(appPath, 'Contents', 'MacOS', 'barkos-computer-use-macos')
...
const bundleId = process.env.ORCA_COMPUTER_MACOS_BUNDLE_ID ?? 'com.barkos.desktop.computer-use'
const displayName = 'BarkOS Computer Use'
...
<dict>
  ...
  <string>barkos-computer-use-macos</string>
  ...
  <string>BarkOS Computer Use needs Accessibility permission to read and interact with app interfaces when you ask BarkOS to use apps.</string>
  <key>NSScreenCaptureUsageDescription</key>
  <string>BarkOS Computer Use needs Screen Recording permission to capture app windows when you ask BarkOS to inspect your screen.</string>
</dict>
</plist>
`
}
